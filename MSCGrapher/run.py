...
parser = argparse.ArgumentParser(description='MSCGrapher for Time Series Forecasting')
...
parser.add_argument('--propalpha', type=float, default=0.1, help='')
parser.add_argument('--conv_channel', type=int, default=32, help='')
parser.add_argument('--skip_channel', type=int, default=32, help='')
parser.add_argument('--in_channel', type=int, default=32, help='')
parser.add_argument('--causal_ratio', type=float, default=0.25, help='causal_ratio')
...
parser.add_argument('--c_dim', type=int, default=512, help='dimension of model')
